    ...
    return (<div className="h-screen bg-zinc-900 flex justify-center items-center">
        <div >
            <div className="border rounded-lg bg-zinc-800 max-w-sm  p-6 ">
                <div className="text-gray-50 mb-4 text-center font-bold text-3xl">Signup</div>
                <div className="mb-2">
                ...
                <div className="flex justify-center">
                    <button className="bg-blue-500 px-4 py-1  rounded cursor-pointer hover:bg-blue-600 shadow shadow-cyan-500/50">Signin</button>
                </div>
